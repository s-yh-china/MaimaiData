...
class SearchLayout(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs), Slider.OnSliderTouchListener {
    ...
    private var versionCheckBoxList = mutableListOf(
        ...
        binding.versionGreenPlusCheckbox,
        binding.versionOrangeCheckbox,
        binding.versionOrangePlusCheckbox,
        binding.versionPinkCheckbox,
        binding.versionPinkPlusCheckbox,
        binding.versionMurasakiCheckbox,
        binding.versionMurasakiPlusCheckbox,
        binding.versionMilkCheckbox,
        binding.versionMilkPlusCheckbox,
