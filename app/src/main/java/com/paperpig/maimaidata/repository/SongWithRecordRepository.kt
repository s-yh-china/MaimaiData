...
class SongWithRecordRepository private constructor(private val songWithRecordDao: SongWithRecordDao) {
    ...
    fun getAllSongWithRecord(
        ...
        return songWithRecordDao.getAllSongWithRecord(includeUtage, ascending)
    }

    fun getAllSong(): List<SongDataEntity> = songWithRecordDao.getAllSong()
    ...
    fun searchSongsWithCharts(
        ...
        val initialResult = songWithRecordDao.searchSongsWithCharts(
    ...
    private val remasterComparator = Comparator<SongWithRecordEntity> { a, b ->
        when {
